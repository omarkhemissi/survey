<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="ManageSurvey.aspx.cs" Inherits="REPORT.Frontend.ManageSurvey" %>

<%--<%@ Register Src="~/UserControls/ucSurvey.ascx" TagPrefix="uc1" TagName="ucSurvey" %>--%>
<%@ Register Src="~/UserControls/ucManageFreeSurvey.ascx" TagPrefix="uc1" TagName="ucSurvey" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <uc1:ucSurvey runat="server" ID="ucSurvey" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
